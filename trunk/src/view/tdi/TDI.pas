...
type
  ...
  private
    ...
    function CriarFormulario(Classe: TFormClass): TForm;
  ...
  public
    ...
    function MostrarFormulario(Classe: TFormClass; Multi: Boolean): TForm;

    procedure GET_ocultarTabs(PageControl: TPageControl); {goveia}
...
function TTDI.MostrarFormulario(Classe: TFormClass; Multi: Boolean):TForm;
const
  EspacosBotaoFechar = '      ';  //espaço destinado p/ o botão 'fechar' de cada aba
var
  Anterior: TTabSheet;
  Form: TForm;
begin                // F_principal.FTDI.MostrarFormulario(TF_cadAptos, False);
...
//  ShowMessage(TFormClass(Classe).ClassName);
  ...
  begin
    ...
    PageControl.TabHeight  := 35;  // 0 padrão
    PageControl.Cursor     := crHandPoint;
    PageControl.Font.Name  := 'Segoe UI Semilight';
    PageControl.Font.Size  := 16;
    PageControl.Font.Color := $00525252;
    {==================================================================================}
...
begin
  ...
  {PageControl.PageCount = 1;;; isso se deve pq este evento eh chamado antes da aba
...
function TTDI.CriarFormulario(Classe: TFormClass):TForm;
  {cria o formulario a partir de sua classe}
const
  EspacosBotaoFechar = '      ';  //espaço destinado p/ o botão 'fechar' de cada aba
var
...
begin
  ...
  begin
    ...
    Align         := alClient;
//    Images        := F_principal.ImageList_32; {coloca um imagelist para deixar mais top}
    Parent        := Self.Parent;
...
procedure TTDI.GET_ocultarTabs(PageControl: TPageControl);
var
  i: Integer;
begin  {ocultar tabs do page control - Goveia 14-03-2021}

  for i := 0 to PageControl.PageCount - 1 do
    PageControl.Pages[i].TabVisible := False;

//  PageControl.ActivePageIndex := 0; {sempre fica na primeira}
end;
