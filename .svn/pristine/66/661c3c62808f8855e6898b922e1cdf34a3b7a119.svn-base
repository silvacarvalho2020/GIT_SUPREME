...
type
  TViewMenu = class(TViewBase)
    ...
    spdcondicao: TSpeedButton;
    pnlVersao: TPanel;
    lblVersao: TLabel;
    spdempresa: TSpeedButton;
    spdformapagamento: TSpeedButton;
    pnlMenuFiscal: TPanel;
    pnlMenuFiscalConteudo: TPanel;
    sdpcfop: TSpeedButton;
    spdpis: TSpeedButton;
    spdncm: TSpeedButton;
    spdnatureza: TSpeedButton;
    ...
    procedure spdempresaClick(Sender: TObject);
    procedure spdformapagamentoClick(Sender: TObject);
    procedure sdpcfopClick(Sender: TObject);
    procedure spdncmClick(Sender: TObject);
...
uses
  ...
  view.tdi.lista.Subgrupos, view.tdi.lista.formaspagamentos,
  view.tdi.lista.cfop, view.tdi.lista.ncm, view.tdi.lista.embalagens,
  view.tdi.lista.cst;
{$R *.dfm}
...
begin
  ...
  case button.Tag of
    ...
    4:begin
      ...
      5:begin
      pnlMenuFinanceiro.Left    := 130;
      pnlMenuFinanceiro.Top     := 200;
      pnlMenuFiscal.Visible := True;
    end;
...
procedure TViewMenu.sdpcfopClick(Sender: TObject);
begin
  inherited;
   pnlMenuFiscal.Visible := False;
   CriarFormulario(TViewListasCfop, False);
end;

procedure TViewMenu.spdempresaClick(Sender: TObject);
begin
  inherited;
  pnlMenuCadastros.Visible := False;
...
procedure TViewMenu.spdformapagamentoClick(Sender: TObject);
begin
  inherited;
  pnlMenuCadastros.Visible := False;
  CriarFormulario(TViewFormasPagamentoTDI, False);
end;

procedure TViewMenu.spdncmClick(Sender: TObject);
begin
  inherited;
   pnlMenuFiscal.Visible := False;
   CriarFormulario(TViewBaseListaNCMTDI, False);
end;
...
begin
  inherited;
   pnlMenuEstoque.Visible := False;
   CriarFormulario(TViewListascstTDI, False);
end;

procedure TViewMenu.SpeedButton7Click(Sender: TObject);
begin
  inherited;
   pnlMenuEstoque.Visible := False;
   CriarFormulario(TViewListasEmbalagensTDI, False);
end;
